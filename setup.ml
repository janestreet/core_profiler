(* OASIS_START *)
(* DO NOT EDIT (digest: c072d782ee394c0a4f403869f37d1b77) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = Some "https://github.com/janestreet/core_profiler";
          ...
          sections =
            [
               Library
                 ({
                     cs_name = "core_profiler_disabled";
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "core_profiler_disabled"
                        ];
                      bs_build_tools =
                   ...
                   {
                      lib_modules =
                        ["Disabled"; "Intf"; "Profiler_units"; "Std"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "core_profiler";
                      lib_findlib_name = Some "disabled";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "core_profiler";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   },
                   {
                      ...
                      lib_findlib_name = Some "core_profiler";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "core_profiler_offline_tool";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "offline_tool/lib";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("core", None);
                           FindlibPackage ("core.syntax", None);
                           InternalLibrary "core_profiler";
                           FindlibPackage ("threads", None);
                   ...
                   },
                   {
                      ...
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "core_profiler";
                      lib_findlib_name = Some "offline_tool";
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "core-profiler-tool";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      bs_build = [(OASISExpr.EBool true, true)];
                      bs_install = [(OASISExpr.EBool true, true)];
                      bs_path = "offline_tool/bin";
                      bs_compiled_object = Best;
                      bs_build_depends =
                        [
                           FindlibPackage ("core", None);
                           FindlibPackage ("core_extended", None);
                           InternalLibrary "core_profiler_offline_tool"
                        ];
                      bs_build_tools =
                        [ExternalTool "ocamlbuild"; ExternalTool "camlp4o"];
                      bs_c_sources = [];
                   ...
                   {exec_custom = false; exec_main_is = "profiler_tool.ml"});
               Executable
                 ({
                     cs_name = "core-profiler-dump-metrics";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "dump_metrics.ml"});
               Executable
                 ({
                     cs_name = "ex-minor-gcs";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "minor_gcs.ml"});
               Executable
                 ({
                     cs_name = "ex-prog1";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "prog1.ml"});
               Executable
                 ({
                     cs_name = "ex-prog2";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "prog2.ml"});
               Executable
                 ({
                     cs_name = "ex-prog3";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "prog3.ml"});
               Executable
                 ({
                     cs_name = "ex-prog4";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "prog4.ml"});
               Executable
                 ({
                     cs_name = "test_bench";
                     cs_data = PropList.Data.create ();
                   ...
                   {exec_custom = false; exec_main_is = "iobuf_bench.ml"})
            ];
          plugins =
            [
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "\146\164W\142\240j\225\148\155\184U\020\1462\b\230";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
