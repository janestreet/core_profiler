(** Use this module for online tracking of perf metrics. When using this module, the
    ...
    + ./inline_benchmarks_runner -q 3 -mat online
      ...
      ├─────────────────────────────────────────────────────┼──────────┼────────────┤ │
      [online.ml:Fstats:Fstats] update_in_place │ 12.96ns │ 6.94% │ │ [online.ml:Timer] at
      │ 11.56ns │ 6.19% │ │ [online.ml:Timer] group_point_at (0 sources) │ 13.31ns │ 7.13%
      │ │ [online.ml:Timer] group_point_at (1 sources) │ 22.91ns │ 12.27% │ │
      [online.ml:Timer] group_point_at (2 sources) │ 40.45ns │ 21.66% │ │
      [online.ml:Timer] group_reset │ 11.58ns │ 6.20% │ │ [online.ml:Probe] at │ 17.94ns │
      9.61% │ │ [online.ml:Probe] group_point_at (0 sources) │ 12.03ns │ 6.44% │ │
      [online.ml:Probe] group_point_at (1 sources) │ 21.35ns │ 11.43% │ │
      [online.ml:Probe] group_point_at (2 sources) │ 32.17ns │ 17.22% │ │
      [online.ml:Probe] group_reset │ 11.32ns │ 6.06% │ │ [online.ml:Delta_timer]
      start_async │ 11.52ns │ 6.17% │ │ [online.ml:Delta_timer] stop_async │ 21.99ns │
      11.77% │ │ [online.ml:Delta_timer] start │ 11.63ns │ 6.23% │ │
      ...
      [online.ml:Delta_probe] start │ 3.16ns │ 1.69% │ │ [online.ml:Delta_probe] stop │
      17.59ns │ 9.42% │ │ [online.ml:Delta_probe] start_async │ 2.96ns │ 1.58% │ │
