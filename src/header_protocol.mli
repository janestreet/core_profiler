...
module New_single : sig
  ...
  type nonrec -'rw t = ([ `New_single ], 'rw) t [@@deriving sexp]
...
module New_group : sig
  ...
  type nonrec -'rw t = ([ `New_group ], 'rw) t [@@deriving sexp]
...
module New_group_point : sig
  ...
  type nonrec -'rw t = ([ `New_group_point ], 'rw) t [@@deriving sexp]
...
module End_of_header : sig
  ...
  type nonrec -'rw t = ([ `End_of_header ], 'rw) t [@@deriving sexp]
...
module Epoch : sig
  ...
  type nonrec -'rw t = ([ `Epoch ], 'rw) t [@@deriving sexp]
